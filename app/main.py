...
# ----------------------------
# Phase10: real model chat API (via LLM Gateway v2)
# ----------------------------
import os
from typing import Optional
